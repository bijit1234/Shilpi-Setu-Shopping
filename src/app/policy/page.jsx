          ...
          <section className="space-y-4">
            ...
            <div className="prose text-[var(--muted)] max-w-none space-y-4 leading-relaxed">
              ...
              <p className="bg-[var(--bg-1)] p-4 rounded-xl border border-[var(--heritage-gold)]/20 inline-block">
                For any privacy-related queries, contact: <a href="mailto:talkto.shilpisetu@gmail.com" className="text-[var(--heritage-red)] font-bold hover:underline">talkto.shilpisetu@gmail.com</a>
              </p>
            </div>
          </section>
