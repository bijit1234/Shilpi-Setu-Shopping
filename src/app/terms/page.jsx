        ...
        <div className="bg-[var(--bg-2)]/90 backdrop-blur-sm rounded-3xl shadow-soft border border-[var(--heritage-gold)]/20 p-8 md:p-12 space-y-10">
          ...
          <section>
            ...
            <ul className="list-disc pl-11 space-y-2 text-[var(--muted)] marker:text-[var(--heritage-gold)]">
              {t('legal.termsOfService.section2Points', { returnObjects: true }).map((point, i) => (<li key={i}>{point}</li>))}
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-11 space-y-2 text-[var(--muted)] marker:text-[var(--heritage-gold)]">
              {t('legal.termsOfService.section3Points', { returnObjects: true }).map((point, i) => (<li key={i}>{point}</li>))}
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-11 space-y-2 text-[var(--muted)] marker:text-[var(--heritage-gold)]">
              {t('legal.termsOfService.section4Points', { returnObjects: true }).map((point, i) => (<li key={i}>{point}</li>))}
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="bg-[var(--bg-1)] p-6 rounded-2xl ml-11 border border-[var(--border)]">
              ...
              <div className="text-sm text-[var(--muted)] space-y-1">
                ...
                <p>{t('legal.termsOfService.emailLabel')}: <a href="mailto:talkto.shilpisetu@gmail.com" className="text-[var(--heritage-red)] hover:underline">talkto.shilpisetu@gmail.com</a></p>
              </div>
            </div>
          </section>
