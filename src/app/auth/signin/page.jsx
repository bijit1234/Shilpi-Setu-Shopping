...
export default function SignIn() {
    ...
    const handleMicrosoftSignIn = async (role) => {
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="card-glass p-8 space-y-8">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              {error && (<div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-600 dark:text-red-400 px-4 py-3 rounded-xl text-sm flex items-center">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input id="password" name="password" type={showPassword ? 'text' : 'password'} autoComplete="current-password" required value={password} onChange={(e) => setPassword(e.target.value)} className="w-full px-4 py-3 bg-[var(--bg-2)] border border-[var(--border)] rounded-xl focus:outline-none focus:ring-2 focus:ring-[var(--saffron)] focus:border-transparent transition-all duration-200 text-[var(--text)] placeholder-[var(--text-muted)] pr-12" placeholder={t('auth.enterYourPassword')}/>
