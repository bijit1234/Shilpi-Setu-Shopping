                ...
                <ul className="space-y-6 text-[var(--muted)]">
                  <li className="flex items-center gap-4 group">
                    ...
                    <div>
                      ...
                      <a href="mailto:talkto.shilpisetu@gmail.com" className="text-[var(--text)] font-medium hover:text-[var(--heritage-red)] transition-colors text-lg">talkto.shilpisetu@gmail.com</a>
                    </div>
                  </li>
                  <li className="flex items-center gap-4 group">
