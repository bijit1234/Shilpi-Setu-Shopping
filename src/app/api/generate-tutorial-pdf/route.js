...
export async function POST(req) {
    const { title = 'Tutorial PDF', steps = [], createdByName = 'Unknown', createdById = null, } = await req.json();
    ...
    const availableWidth = (w) => w - MARGIN_LEFT - MARGIN_RIGHT;
    ...
    const drawLines = (lines, size, xOffset = MARGIN_LEFT) => {
    ...
    for (const p of pages) {
        ...
        p.drawText(watermarkText, {
            ...
            opacity: 0.12, // some environments/types may need this cast
        });
    }
