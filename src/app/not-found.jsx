...
export default function NotFound() {
    ...
    return (<div className="relative min-h-screen overflow-hidden flex items-center justify-center bg-black">
            <HideNavbar />

            {/* Background Image with Parallax Effect */}
            <div className="absolute inset-0 z-0">
                <Image src="/notfound.png" alt={t('notfound.brokenPotAlt', 'Broken pot in desert')} fill className="object-cover object-center scale-105 animate-subtle-zoom" priority quality={90}/>
            ...
            <div className="relative z-10 w-full max-w-2xl text-center px-6 animate-fade-in-up">
                ...
                <div className="mb-6">
                    <h2 className="text-8xl md:text-9xl font-black text-white/10 tracking-tight leading-none select-none" style={{ textShadow: '0 0 40px rgba(255,255,255,0.1)' }}>
                        404
                    </h2>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Link href="/" className="group relative inline-flex items-center gap-3 bg-[var(--heritage-gold)] px-8 py-4 rounded-full text-white font-semibold hover:bg-[var(--heritage-gold)]/90 transition-all duration-300 shadow-2xl hover:shadow-[var(--heritage-gold)]/50 hover:scale-105 overflow-hidden">
