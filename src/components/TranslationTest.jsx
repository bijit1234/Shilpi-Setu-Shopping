    ...
    return (<div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
      ...
      <div className="space-y-4">
        <div>
          ...
          <input type="text" value={testText} onChange={(e) => setTestText(e.target.value)} className="w-full p-2 border rounded"/>
        </div>
        <div>
        ...
        <button onClick={testTranslation} disabled={loading} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 disabled:opacity-50">
