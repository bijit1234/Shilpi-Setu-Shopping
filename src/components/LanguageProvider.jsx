...
export function LanguageProvider({ children }) {
    ...
    if (!mounted) {
        return (<LanguageContext.Provider value={{ currentLanguage, changeLanguage, isLoading: true }}>
        {children}
      </LanguageContext.Provider>);
    }
    return (<LanguageContext.Provider value={{ currentLanguage, changeLanguage, isLoading }}>
      {children}
    </LanguageContext.Provider>);
}
