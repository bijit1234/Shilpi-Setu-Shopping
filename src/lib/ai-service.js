...
export class AIService {
     ...
     */
    async analyzeProductPdf(file, context) {
        try {
     ...
     */
    async generateSellerTips(snapshot) {
...
Return plain text with bullets. Keep under 1200 characters.`;
     ...
     */
    async answerSellerQuestion(snapshot, question) {
...
Answer as a pragmatic marketplace strategist. Give specific, short recommendations. Use bullets if helpful. Keep it under 800 characters.`;
     ...
     */
    async generateStoreDescription(sellerName, bio, products) {
        try {
            const prompt = `
     ...
     */
    async analyzeProductImageFromFile(file, options) {
        try {
     ...
     */
    async enhanceDescription(existingDescription, category) {
        try {
            const prompt = `
     ...
     */
    async getPricingInsights(category, materials) {
        try {
            const prompt = `
